...
def startGui(filename):
    '''
    Start simple pygame program for manual testing of neural network
    borrowed from https://github.com/KevinLiTian/Harvard_CS50_AI/blob/main/5.Neural_Networks/examples/digits/recognition.py 
    '''
    ...
    while True:
        ...
        if mouse and classifyButton.collidepoint(mouse):
            res = neuralNet.getRes(np.array(handwriting).reshape(28*28))
