...
- train - Traind neural net, use flags from help to congfigure train process
- test - Test neural net on test set of data
- gui - Manualy test neural net writing digits manualy
